...
const CAT_NAMES := {
	...
	"investimentos": "Investimentos", "aporte": "Aporte do novo dono", "renegociacao": "Dívida renegociada",
	"saida_dono": "Dívida deixada pelo dono", "impostos": "Impostos",
}
const INCOME_CATS: Array[String] = ["bilheteria", "tv", "patrocinio", "loja", "premiacao", "vendas", "aporte", "renegociacao"]
