...
function go_verge_v7_category_priority() {
	return array(
		...
		'celulares','mobilidade','internet','hardware','notebooks','tvs-e-monitores','eletrodomesticos','casa-inteligente','wearables','apps-software','ia','ciencia','servico',
...
function go_verge_v7_category_sitemap_args( $args, $taxonomy ) {
	...
	$ids = array();
	$terms = get_terms( array( 'taxonomy' => 'category', 'hide_empty' => false, 'number' => 5000, 'update_term_meta_cache' => false ) );
	if ( ! is_wp_error( $terms ) ) {
		foreach ( $terms as $term ) {
	...
	if ( $ids ) { $args['include'] = array_values( array_unique( $ids ) ); $args['hide_empty'] = false; }
	return $args;
}
...
function go_verge_v7_nav_blueprint() {
	...
	return array(
		...
		array('label'=>'Tecnologia','url'=>go_verge_v7_category_url('tecnologia'),'items'=>array(
			array('Celulares',go_verge_v7_category_url('celulares')),array('Auto e Mobilidade',go_verge_v7_category_url('mobilidade')),array('Internet',go_verge_v7_category_url('internet')),array('Hardware',go_verge_v7_category_url('hardware')),array('Notebooks',go_verge_v7_category_url('notebooks')),array('TVs e Monitores',go_verge_v7_category_url('tvs-e-monitores')),array('Eletrodomésticos',go_verge_v7_category_url('eletrodomesticos')),array('Casa Inteligente',go_verge_v7_category_url('casa-inteligente')),array('Wearables',go_verge_v7_category_url('wearables')),array('Apps e Software',go_verge_v7_category_url('apps-software')),array('Inteligência Artificial',go_verge_v7_category_url('ia')),array('Ciência e Mundo',go_verge_v7_category_url('ciencia')),array('Serviço',go_verge_v7_category_url('servico')),
		)),
