 ...
 *
 * Delivery model: manual inventory and account-managed Auto ads.
 *
 * The theme owns its manual opportunities. The shared provider loader also
 * serves Auto ads, including in-page formats, as configured in the account.
 * Local compatibility never changes or confirms those account settings.
 *
