...
<p>O Overdrive é um veículo gratuito, sustentado por publicidade. Para viabilizar isso, trabalhamos com serviços de anúncios fornecidos por terceiros, entre eles o <strong>Google AdSense</strong> e demais produtos de publicidade do Google, além de eventuais redes e anunciantes diretos.</p>
...
<p>O conteúdo do Overdrive é dirigido ao público geral interessado em games, mas não coletamos intencionalmente dados de crianças e adolescentes sem o consentimento específico e em destaque de ao menos um dos pais ou responsável legal, conforme o art. 14 da LGPD. Se identificarmos coleta indevida — ou se um responsável nos comunicar pelo e-mail <strong><a href="mailto:contato@gameoverdrive.com.br">contato@gameoverdrive.com.br</a></strong> —, os dados serão eliminados.</p>
<h2 id="12-links-para-sites-de-terceiros">12. Links para sites de terceiros</h2>
<p>O site contém links para lojas, redes sociais, vídeos, distribuidoras e outros portais. Ao clicar, você passa a se relacionar diretamente com esses terceiros, sujeitando-se às políticas de privacidade deles. O Overdrive não controla nem se responsabiliza pelas práticas de privacidade desses sites.</p>
...
function go_verge_prepare_privacy_policy_page() {
	...
	$excerpt      = 'Como o Overdrive coleta, utiliza, compartilha e protege dados pessoais, cookies e informações de navegação conforme a LGPD.';
	$page         = go_verge_privacy_policy_page();
	$page_id      = 0;
