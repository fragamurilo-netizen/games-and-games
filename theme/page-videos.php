...
<main id="primary" class="go-main go-videos-page">
	...
	<section class="go-container go-section go-videos-page__channels" data-go-video-platform-tabs>
		<div class="go-videos-page__section-head">
			...
			<div class="go-videos-page__tabs" role="tablist" aria-label="<?php esc_attr_e( 'Plataformas', 'go-verge' ); ?>">
				...
				<?php foreach ( $go_video_platforms as $go_video_key => $go_video_platform ) : ?>
					<button type="button" role="tab" class="go-videos-page__tab<?php echo 0 === $go_video_tab_index ? ' is-active' : ''; ?>" id="go-video-tab-<?php echo esc_attr( $go_video_key ); ?>" aria-controls="go-video-panel-<?php echo esc_attr( $go_video_key ); ?>" tabindex="<?php echo 0 === $go_video_tab_index ? '0' : '-1'; ?>" data-go-video-platform-tab="<?php echo esc_attr( $go_video_key ); ?>" aria-selected="<?php echo 0 === $go_video_tab_index ? 'true' : 'false'; ?>">
		...
		<?php foreach ( $go_video_platforms as $go_video_key => $go_video_platform ) : ?>
			...
			<div class="go-videos-page__panel<?php echo 0 === $go_video_panel_index ? ' is-active' : ''; ?>" data-go-video-platform-panel="<?php echo esc_attr( $go_video_key ); ?>" role="tabpanel" id="go-video-panel-<?php echo esc_attr( $go_video_key ); ?>" aria-labelledby="go-video-tab-<?php echo esc_attr( $go_video_key ); ?>" tabindex="0"<?php echo 0 === $go_video_panel_index ? '' : ' hidden'; ?>>
