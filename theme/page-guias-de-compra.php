...
$go_bg_filter_slug  = isset( $_GET['editoria'] ) && is_scalar( $_GET['editoria'] ) ? sanitize_title( wp_unslash( (string) $_GET['editoria'] ) ) : ''; // phpcs:ignore WordPress.Security.NonceVerification.Recommended
...
$go_bg_type_slug = isset( $_GET['tipo'] ) && is_scalar( $_GET['tipo'] ) ? sanitize_title( wp_unslash( (string) $_GET['tipo'] ) ) : ''; // phpcs:ignore WordPress.Security.NonceVerification.Recommended
