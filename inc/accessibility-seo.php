...
function go_verge_accessibility_summary() {
	return __( 'O Game Overdrive oferece navegação estrutural, link para pular ao conteúdo, controles de contraste e tamanho do texto, modo leitura, redução de movimento, operação por teclado e leitura em voz alta de matérias quando o navegador oferece síntese de voz.', 'go-verge' );
}
...
function go_verge_prepare_accessibility_page() {
	...
	if ( ! $existing ) {
		$content = <<<'HTML'
<!-- wp:paragraph -->
<p>O Game Overdrive trabalha para que suas matérias e páginas possam ser usadas por mais pessoas, em diferentes dispositivos e formas de navegação. Os recursos abaixo fazem parte do próprio site e podem evoluir conforme a plataforma é atualizada.</p>
<!-- /wp:paragraph -->
...
<!-- wp:paragraph -->
<p>Vídeos, players, anúncios e outros conteúdos incorporados podem ter controles próprios e limitações que não dependem diretamente do Game Overdrive. Sempre que possível, buscamos integrar esses elementos sem impedir a navegação principal do site.</p>
<!-- /wp:paragraph -->
