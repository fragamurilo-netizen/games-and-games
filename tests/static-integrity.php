...
s_ok(strpos($style, 'Version: 5.5.5') !== false, 'Versão pública do tema é 5.5.5');
$functions = file_get_contents($root.'/functions.php');
s_ok(strpos($functions, "define( 'GO_VERGE_VERSION', '5.5.5' );") !== false, 'GO_VERGE_VERSION acompanha a versão pública 5.5.5');
